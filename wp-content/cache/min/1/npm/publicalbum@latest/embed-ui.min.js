...
function tc(a,b){if(a==b)throw Error("Unable to set parent component");var c;if(c=b&&a.F&&a.qa){c=a.F;var d=a.qa;c=c.I&&d?q(c.I,d)||null:null}if(c&&a.F!=b)throw Error("Unable to set parent component");a.F=b;rc.g.Ka.call(a,b)}e.Ka=function(a){if(this.F&&this.F!=a)throw Error("Method not supported");rc.g.Ka.call(this,a)};e.w=function(){this.m=D(this.i,"DIV")};function I(a,b,c){if(a.H)throw Error("Component already rendered");a.m||a.w();b?b.insertBefore(a.m,c||null):a.i.a.body.appendChild(a.m);a.F&&!a.F.H||a.A()}e.$=function(a){if(this.H)throw Error("Component already rendered");if(a){this.ga=!0;var b=Sb(a);this.i&&this.i.a==b||(this.i=Qb(a));this.D(a);this.A()}else throw Error("Invalid element to decorate")};e.D=function(a){this.m=a};e.A=function(){this.H=!0;J(this,function(a){!a.H&&a.c()&&a.A()})};e.ha=function(){J(this,function(a){a.H&&a.ha()});this.P&&pc(this.P);this.H=!1};e.N=function(){this.H&&this.ha();this.P&&(Na(this.P),delete this.P);J(this,function(a){Na(a)});!this.ga&&this.m&&Xb(this.m);this.F=this.m=this.I=this.B=null;rc.g.N.call(this)};e.T=function(a,b){var c=K(this);if(a.H&&(b||!this.H))throw Error("Component already rendered");if(0>c||c>K(this))throw Error("Child component index out of bounds");this.I&&this.B||(this.I={},this.B=[]);if(a.F==this){var d=sc(a);this.I[d]=a;Ha(this.B,a)}else{d=this.I;var f=sc(a);if(null!==d&&f in d)throw Error('The object already contains the key "'+f+'"');d[f]=a}tc(a,this);Ia(this.B,c,0,a);a.H&&this.H&&a.F==this?(b=this.ia(),c=b.childNodes[c]||null,c!=a.c()&&b.insertBefore(a.c(),c)):b?(this.m||this.w(),c=L(this,c+1),I(a,this.ia(),c?c.m:null)):this.H&&!a.H&&a.m&&a.m.parentNode&&1==a.m.parentNode.nodeType&&a.A()};e.ia=function(){return this.m};function K(a){return a.B?a.B.length:0}function L(a,b){return a.B?a.B[b]||null:null}function J(a,b,c){a.B&&t(a.B,b,c)}e.removeChild=function(a,b){if(a){var c=l(a)?a:sc(a);a=this.I&&c?q(this.I,c)||null:null;if(c&&a){var d=this.I;c in d&&delete d[c];Ha(this.B,a);b&&(a.ha(),a.m&&Xb(a.m));tc(a,null)}}if(!a)throw Error("Child is not in parent component");return a};function uc(a){for(var b=[];a.B&&0!=a.B.length;)b.push(a.removeChild(L(a,0),!0));return b};function M(a){rc.call(this,a);this.Aa=!0}p(M,rc);e=M.prototype;e.M=function(a){this.Aa=a};function N(a){a.M(!1)}function O(a){return a.H&&a.Aa}e.T=function(a,b){a.M(this.Aa);M.g.T.call(this,a,b)};e.update=function(){var a=this.c();a.tabIndex=-1;a.removeAttribute("tabIndex")};e.v=function(){return"jx"};e.A=function(){M.g.A.call(this);O(this)&&this.update()};var vc=/#(.)(.)(.)/;function wc(a,b,c){a=Number(a);b=Number(b);c=Number(c);if(a!=(a&255)||b!=(b&255)||c!=(c&255))throw Error('"('+a+","+b+","+c+'") is not a valid RGB color');return"#"+xc(a.toString(16))+xc(b.toString(16))+xc(c.toString(16))}function yc(a){return wc(a[0],a[1],a[2])}var zc=/^#(?:[0-9a-f]{3}){1,2}$/i;function xc(a){return 1==a.length?"0"+a:a};function Ac(a){M.call(this,a);this.h=this.u=this.j=null;this.G=!1;this.f=[];this.K=this.R=this.V=this.J=!0;this.o=this.l=this.a=this.s=null;this.C=Bc}p(Ac,M);var Bc=500;function Cc(a,b){if(l(b)){var c=new Dc;c.src=b;b=c}Ga(a.f,b);O(a)&&a.update()}function Ec(a,b,c){a=Math.round(Math.sqrt(Math.pow(a.j.width,2)+Math.pow(a.j.height,2))/Math.sqrt(Math.pow(a.h.width,2)+Math.pow(a.h.height,2)));E(b,"filter",c?"blur("+a+"px)":"none")}e=Ac.prototype;e.Bc=function(){F(this.a,1);this.S=setTimeout(m(this.Ac,this),1.25*this.C)};e.Ac=function(){clearTimeout(this.S);this.S=null;E(this.s,Fc);E(this.s,Gc);Ec(this,this.s,this.G);null!==this.o&&Hc(this,this.o);this.o=null};function Hc(a,b){if(a.l!=b){var c=a.f[b]?a.f[b]:void 0;c&&(a.a?a.o=b:(a.C=Bc*(null===a.l?.3:1),a.l=b,a.o=null,a.a||(a.a=D(a.i,"IMG"),a.b.appendChild(a.a),E(a.a,Jc),b=a.C,E(a.a,"transition",0<b?"opacity "+.001*b+"s ease":"none"),x(a.a,"load",a.Db,!1,a)),E(a.a,"z-index",2),F(a.a,0),a.a.src=c.src))}}
...
function ze(a,b){var c=b.src?b.src:"";switch(b.a){case "video/mp4":var d=new Td;d.C=c;d.f=Kd;O(d)&&d.pa();a.L=d;a.T(a.L,!a.L.H);break;default:d=new ke;null!==b.width&&0<b.width&&null!==b.height&&0<b.height&&(d.u=new C(b.width,b.height),O(d)&&(d.j=hc(d.c()),Lc(d)));d.J=b.aspectRatio;O(d)&&Lc(d);d.R=b.Ea;O(d)&&Lc(d);d.V=b.stretch;O(d)&&Lc(d);d.K=b.Ca;O(d)&&Lc(d);if(b.wa){var f=new Dc;f.src=b.wa;f.width=0;f.height=0;Cc(d,f)}f=new Dc;f.src=c;Cc(d,f);a.L=d;a.T(a.L,!a.L.H)}l(b.description)&&(c=new ae,c.b=b.description,O(c)&&$b(c.a,null!==c.b?c.b:""),a.T(c,!0))}e.pb=function(){this.b=this.f.contentWindow.document.body;E(this.b,Ae);E(this.b.parentElement,Ae);this.h.call(this)};function Be(a,b){a.h=b;b=document.createElement("IFRAME");b.setAttribute("frameborder","0");b.setAttribute("marginwidth","0");b.setAttribute("marginheight","0");b.setAttribute("scrolling","no");b.setAttribute("allowfullscreen",!0);b.setAttribute("srcdoc","");b.setAttribute("id","iframe"+sc(a));var c=a.c();c.insertBefore(b,c.childNodes[0]||null);a.f=b;E(b,Ce);x(b,"load",a.pb,!1,a)}
